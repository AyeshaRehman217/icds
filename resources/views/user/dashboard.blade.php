        ...
        <div class="card-body">
            ...
            <div class="row justify-content-center">
                        ...
                        <div class="col-sm-5 mb-sm-2 my-3">
                            <div class="justify-content-center d-flex">
                                <a href="{{route('user.abstract-submission.index')}}" class="text-medium-emphasis" style="text-decoration: none;color:#3c4b64!important;"><i class="fa-solid fa-paperclip" style="font-size: 3.5rem"></i></a> 
                                <div class="d-inline text-center mx-4 mt-3">
                                <a href="{{route('user.abstract-submission.index')}}" class="text-medium-emphasis" style="text-decoration: none;color:#3c4b64!important;"><strong>Abstract Submission</strong></a>
                                {{-- <div class="fw-semibold" style="font-size:1.25rem">{{$userCount}}</div> --}}
                                </div> 
                                </div>
                        </div>
