...
{{--            <li class="nav-item"><a class="nav-link" href="javascript:void(0)">{{(request()->has('sid') ? 'SID: ' . request()->input('sid') : '') }}</a></li>--}}
        </ul>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-md">
                        ...
                        @else
                            <img class="avatar-img" src="{{asset('manager/coreui')}}/assets/img/avatars/profile1.jpg" alt="user@email.com">
                        @endif
                    </div>
                </a>
