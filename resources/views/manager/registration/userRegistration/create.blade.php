...
{{--                <div class="mb-3">--}}
{{--                    <label class="form-label" for="submission">Submission Type</label>--}}
...
@push('footer-scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.select2-options-payment-id').change(function () {
                let payment = $(this).val();
                if(payment == 2) {
                $('.select2-options-submission-id').prop("disabled", false);
                $('.select2-options-submission-id').empty()
                //Select States
                $('.select2-options-submission-id').select2({
                    theme: "bootstrap5",
                    placeholder: 'Select Submission Type',
                ...
                $('.select2-options-submission-id').prop("disabled", true);
                $('.select2-options-submission-id').empty()
            }
