...
{{--                <div class="mb-3">--}}
{{--                    <label class="form-label" for="submission">Onsite Submission Type</label>--}}
{{--                    <select disabled class="form-control select2-options-submission-id  @error('submission') is-invalid @enderror" name="submission"></select>--}}
{{--                    @error('submission')--}}
{{--                    <strong class="text-danger">{{ $message }}</strong>--}}
{{--                    @enderror--}}
{{--                </div>--}}
