        ...
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('amount') is-invalid @enderror" name="amount" id="amount" placeholder="Fee" value="{{old('amount')}}">
                    @error('amount')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('dollar-amount') is-invalid @enderror" name="dollar-amount" id="dollar-amount" placeholder="International Fee" value="{{old('dollar-amount')}}">
                    @error('dollar-amount')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
