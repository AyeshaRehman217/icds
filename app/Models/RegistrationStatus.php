...
class RegistrationStatus extends Model
{
    ...
    {
        return $this->hasMany(UserRegistration::class,'registration_status_id');
    }

    public function abstract_submissions()
    {
        return $this->hasMany(AbstractSubmission::class,'registration_status_id');
    }
